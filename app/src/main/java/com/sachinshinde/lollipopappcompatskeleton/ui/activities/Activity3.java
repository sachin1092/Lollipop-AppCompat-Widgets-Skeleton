 ...
 */
public class Activity3 extends BaseActivity implements
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        bundle.putString("Title", "Activity 3");
    ...
    public int getSelectedFragment() {
        return BaseActivity.NAVDRAWER_ITEM_ACTIVITY3;
    }

    protected int getSelfNavDrawerItem() {
        return NAVDRAWER_ITEM_ACTIVITY3;
    }
}
